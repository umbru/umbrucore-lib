# Umbru Address
Represents a Umbru address. Addresses are the most popular way to make Umbru transactions. 
...
The errors are listed in the generated file in the [errors folder](https://github.com/umbru/bitcore-umbru/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/umbru/bitcore-umbru/tree/master/lib/errors/spec.js).
