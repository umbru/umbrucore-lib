...
For detailed technical information about a block please visit [Blocks](https://docs.umbru.io) on the Umbru Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://docs.umbru.io) page on the Umbru Developer Reference Wiki.
